	...
	for ntiid, evaluation in list(site_registry.getUtilitiesFor(IQEvaluation)):
		...
		for provided in ( IQuestionBank, IRandomizedQuestionSet, IQuestionSet ):
			if implemented_iface != provided:
				registered = site_registry.queryUtility(provided, name=evaluation.ntiid)
				if registered is not None:
					unregisterUtility(site_registry, provided=provided, name=evaluation.ntiid)
					registerUtility(site_registry, evaluation, provided=implemented_iface,
