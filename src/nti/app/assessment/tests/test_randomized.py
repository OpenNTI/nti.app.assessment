...
class TestRandomized(ApplicationLayerTest):
    ...
    def test_random(self):
        ...
        self._validate_random_qset_and_parts(students, assignment_href,
                                            random_set=True, random_parts=True, start_attempt=True)

    def _validate_random_qset_and_parts(self, students, href, random_set=True, random_parts=True, start_attempt=False):
        """
