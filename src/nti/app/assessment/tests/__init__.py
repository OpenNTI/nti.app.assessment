...
class RegisterAssignmentLayer(InstructedCourseApplicationTestLayer):
    ...
    def _register_assignment(cls):
        ...
        def install_questions():
            ...
            poll_ntiid = u"tag:nextthought.com,2011-10:OU-NAQ-CLC3403_LawAndJustice.naq.pollid.aristotle.1"
            ...
            # Make sure our assignment is indexed to our page and course
            # content package.
            lesson_page_id = u"tag:nextthought.com,2011-10:OU-HTML-CLC3403_LawAndJustice.sec:QUIZ_01.01"
            ...
            content_package_ntiid = u'tag:nextthought.com,2011-10:OU-HTML-CLC3403_LawAndJustice.clc_3403_law_and_justice'
            catalog.index(assignment, 
                          container_ntiids=(lesson.ntiid, content_package_ntiid))
            ...
            cls.question_id = u'tag:nextthought.com,2011-10:OU-NAQ-CLC3403_LawAndJustice.naq.qid.aristotle.1'
...
class RegisterAssignmentsForEveryoneLayer(RegisterAssignmentLayer):
    ...
    @classmethod
    def setUp(cls):
        from nti.app.assessment.assignment_filters import UserEnrolledForCreditInCourseOrInstructsFilter
